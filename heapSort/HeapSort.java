...
public class HeapSort {
    ...
    public static void heapSort(BufferPool bufferPool, int numRecords) throws IOException {
    ...
    private static void buildHeap(BufferPool bufferPool, int numRecords) throws IOException {
        for (int i = numRecords / 2 - 1; i >= 0; i--) {
            heapify(bufferPool, numRecords, i);
        }
    }

    private static void heapify(BufferPool bufferPool, int heapSize, int rootIndex) throws IOException {
    ...
    private static int compare(BufferPool bufferPool, int index1, int index2) throws IOException {
    ...
    private static void swap(BufferPool bufferPool, int index1, int index2) throws IOException {
